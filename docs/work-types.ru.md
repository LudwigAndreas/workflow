...
|---|---|---|
| Бампы зависимостей | Renovate, self-hosted, пачкой раз в неделю | подтвердить PR |
...
единственное исключение, которое делают проверки, и единственное, которое они
когда-либо должны делать. Renovate здесь self-hosted, потому что это тот бот
зависимостей, который умеет Bitbucket Data Center; Dependabot — нет.
