# frontend — spec-driven workflow

`frontend` is the user-facing web client, one repository of a multirepo application.
...
| Which part of it is mine? | that intent's `handoff.md`, the section for `frontend` |
